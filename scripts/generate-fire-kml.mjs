...
function fmtAcres(a) {
  ...
  return isNaN(n) ? String(a) : `${n.toLocaleString('en-US', { maximumFractionDigits: 1 })} acres`
}
...
<Document>
  ...
  <description>Washington DNR jurisdiction fire incidents, 2025 season. Source: WADNR ArcGIS Feature Service. Generated by MorelFinder CI.</description>
  <Style id="fire">
    <IconStyle>
